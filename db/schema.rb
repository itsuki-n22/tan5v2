...
ActiveRecord::Schema.define(version: 2021_04_19_132242) do
  ...
  create_table "tango_configs", force: :cascade do |t|
    ...
    t.index ["user_id", "wordnote_id"], name: "index_tango_configs_on_user_id_and_wordnote_id", unique: true
  ...
  create_table "tango_data", force: :cascade do |t|
    ...
    t.index ["user_id", "tango_id"], name: "index_tango_data_on_user_id_and_tango_id", unique: true

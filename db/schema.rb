...
ActiveRecord::Schema.define(version: 20_200_617_153_830) do
  ...
  create_table 'favorites', force: :cascade do |t|
    ...
    t.index %w[user_id wordnote_id], name: 'index_favorites_on_user_id_and_wordnote_id', unique: true
  ...
  create_table 'tango_data', force: :cascade do |t|
    ...
    t.index %w[user_id wordnote_id tango_id], name: 'index_tango_data_on_user_id_and_wordnote_id_and_tango_id', unique: true
  ...
  create_table 'tangos', force: :cascade do |t|
    ...
    t.index %w[wordnote_id created_at], name: 'index_tangos_on_wordnote_id_and_created_at'
  end
